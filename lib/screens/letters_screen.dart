...
class _LettersScreenState extends State<LettersScreen> {
  ...
  Widget _buildLetterCard({
    ...
    return Stack(
      ...
      onTap: () async {
        if (letter.isArabic) {
          await audio.speakArabic(letter.spokenSound);
        } else {
          await audio.speakEnglish(letter.spokenSound);
        }
      ...
      child: Container(
        ...
        // زر صغير ثانوي لسماع اسم الحرف (وليس صوته) - إضافة تعليمية اختيارية
        Positioned(
          top: 2,
          right: 2,
          child: GestureDetector(
            onTap: () async {
              if (letter.isArabic) {
                await audio.speakArabic(letter.name);
              } else {
                await audio.speakEnglish(letter.nameEn);
              }
            },
            child: Container(
